 ...
 * @author Isabella
 */
public class TextoPredeterminado extends JLabel implements FocusListener, DocumentListener {
	/**
	 * 
	 */
	...
	public TextoPredeterminado(String text, JTextComponent component) {
		this(text, component, Show.ALWAYS);
	}

	public TextoPredeterminado(String text, JTextComponent component, Show show) {
